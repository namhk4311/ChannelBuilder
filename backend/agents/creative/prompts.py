...
CHỐNG LẶP HÌNH (quan trọng): câu thoại đọc DÀI mà tag chỉ có ít clip → video sẽ LẶP LẠI cùng 1 scene.
Để tránh: (1) câu dài ưu tiên gán tag NHIỀU clip (canteencafe, khonggianmo, buzones, campusngoaicanh);
(2) nếu ý dài, TÁCH thành 2-3 câu mỗi câu một tag KHÁC nhau (mỗi cảnh đổi mới); (3) khi buộc gán câu dài
vào tag mỏng, BẮT BUỘC điền alt_tag là tag CÙNG PILLAR (campus↔campus, bu↔bu) để có thêm clip lấp hình.
